    ...
    <nav class="flex mb-4" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            <li class="inline-flex items-center">
                <a href="{{ route('projects.index') }}" class="text-gray-700 hover:text-blue-600">
                    < Return to show
                </a>
            </li>
        </ol>
    </nav>
    <h2 class="text-3xl font-extrabold">Details van {{ $project->name }}</h2>
@endsection
        ...
        <div class="border-t border-gray-200">
            <dl>
                ...
                <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $project->created_at }}</dd>
                </div>
            </dl>
        </div>
    </div>
