    ...
    <nav class="mb-6 border-b">
        <div class="max-w-7xl mx-auto flex items-center gap-6 text-sm">
            <a href="{{ route('brands.index') }}"
               class="py-3 font-medium text-gray-700 hover:text-blue-900">Brands</a>
            <a href="{{ route('brands.create') }}"
               class="py-3 font-medium text-blue-900 border-b-2 border-blue-900">Add Brand</a>
        </div>
    </nav>
@endsection
...
@section('content')
    <div class="max-w-lg mx-auto bg-white border rounded shadow-sm">
        <div class="px-6 py-4 border-b">
            <h1 class="text-lg font-semibold">Add Brand</h1>
        </div>
